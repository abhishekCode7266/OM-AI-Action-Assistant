  ...
  loadPreset(presetKey) {
    ...
    if (presetKey === 'quantum_ai') {
      this.nodes = [
        ...
        { id: 'security', label: 'Cryptographic Security & VIP Matrix', subtext: 'Free VIP for Abhishek singh Yadav', category: 'security', x: 230, y: 130, radius: 28, color: '#ec4899', status: 'complete', meta: 'Enterprise-grade zero-cost authorization matrix.' },
